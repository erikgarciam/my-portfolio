...
public final class FindMeetingQueryTest {
  ...
  public void noConflicts() {
    ...
    @Test
  public void OptionalAttendantIsConsideredAllDay() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, DURATION_2_HOUR),
  ...
  @Test
  public void OptionalAttendantIsConsidered() {
...
@Test
  ...
  @Test
  public void optionsForNoAttendeesWithGap() {
...
@Test
  public void optionsForNoAttendeesWithNoGap() {
    
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY +1),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY +1),
            Arrays.asList(PERSON_B)));
